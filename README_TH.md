...
## อะไรคือ Blora-Manager?

**Blora-Manager Panel** (MCSM) คือ **แผงควบคุมที่ทันสมัย ​​ปลอดภัย** ถูกออกแบบมาเพื่อจัดการเซิรฟ์เวอร์ Minecraft และเซิร์ฟเวอร์สตรีมเกมส์ 

Blora-Manager ได้รับความนิยมในระดับหนึ่งในชุมชนแล้ว โดยเฉพาะอย่างยิ่งเนื่องมาจาก Minecraft Blora-Manager โดดเด่นในด้านการนำเสนอโซลูชันการจัดการแบบรวมศูนย์สำหรับอินสแตนซ์เซิร์ฟเวอร์หลายตัว และมอบระบบการอนุญาตผู้ใช้หลายคนที่ปลอดภัยและเชื่อถือได้ นอกจากนี้ เรายังมุ่งมั่นที่จะสนับสนุนผู้ดูแลระบบเซิร์ฟเวอร์ ไม่เพียงแต่สำหรับ Minecraft เท่านั้น แต่ยังรวมถึง Terraria และเกม Steam ต่างๆ ด้วย เป้าหมายของเราคือการส่งเสริมชุมชนที่เจริญรุ่งเรืองและให้การสนับสนุนสำหรับการจัดการเซิร์ฟเวอร์เกม

Blora-Manager **รองรับ อังกฤษ ฝรั่งเศส เยอรมัน อิตาลี ไทย ญี่ปุ่น โปรตุเกส จีนตัวย่อ และจีนตัวเต็ม** พร้อมแผนที่จะเพิ่มการรองรับภาษาอื่นๆ เพิ่มเติมในอนาคต!
...
6. เทคโนโลยีสแต็กนั้นเรียบง่าย และคุณเพียงแค่ต้องมีความสามารถในการเขียน TypeScript ก็สามารถทำให้การพัฒนา Blora-Manager เสร็จสมบูรณ์ได้ทั้งหมด
7. และอีกมากมาย!
...
ไปที่ : [https://Blora-Manager.com/](https://Blora-Manager.com/)
...
- ที่อยู่การติดตั้ง: `/opt/Blora-Manager/`.
...
วิธีการติดตั้งนี้จะไม่ตั้งค่า Blora-Manager เป็นบริการระบบโดยอัตโนมัติ ดังนั้น จึงจำเป็นต้องใช้ `screen` สำหรับการจัดการ สำหรับผู้ที่สนใจในการจัดการ Blora-Manager ผ่านบริการระบบ โปรดดูที่ wiki/documentation ของเรา
...
เราใช้ "VS Code" เพื่อพัฒนา Blora-Manager คุณอาจต้องติดตั้งปลั๊กอินเหล่านี้:
...
คุณต้องการไปที่ [PTY](https://github.com/Blora-Manager/PTY) และ [Zip-Tools](https://github.com/Blora-Manager/Zip-Tools) โครงการที่จะดาวน์โหลดไฟล์ไบนารีที่สอดคล้องกันและวางไว้ในไดเร็กทอรี `daemon/lib` เพื่อให้แน่ใจว่า `Emulation Terminal` และ `File Decompression` ทำงานอย่างเหมาะสม
...
หากคุณพบปัญหาใดๆ ขณะใช้ Blora-Manager คุณสามารถ [ส่งปัญหา](https://github.com/BloretCrew/Blora-Manager/issues/new/choose) ได้หรือคุณสามารถแยกโปรเจ็กต์และมีส่วนร่วมโดยตรงได้โดยส่ง Pull Request

โปรดตรวจสอบให้แน่ใจว่าโค้ดที่ส่งมาทั้งหมดเป็นไปตามรูปแบบการเขียนโค้ดที่มีอยู่ของเรา สำหรับรายละเอียดเพิ่มเติม โปรดดูแนวทางที่ระบุไว้ใน [ฉบับนี้](https://github.com/BloretCrew/Blora-Manager/issues/544)
...
**ปัญหาที่ยังไม่ได้รับการแก้ไข:** [คลิกที่นี่](https://github.com/BloretCrew/Blora-Manager/issues/new/choose)
...
ซอร์สโค้ดของ Blora-Manager ได้รับอนุญาตภายใต้ใบอนุญาต [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0)

ลิขสิทธิ์ ©2025 Blora-Manager
